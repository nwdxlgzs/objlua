...
> 虽然objlua是基于5.4.7版本开发，但是基于安全修复需求，现已支持5.4.8相关更新与截止2025年7月5日可以查到的对5.4.8的[修补补丁](https://lua.org/bugs.html)，即objlua等效基于5.4.8（严格的说是半个5.4.9）开发，这也是为什么你会看到版本号实际不是5.4.7。
